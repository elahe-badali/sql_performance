...
drop materialized view if exists "student_elaheh_badali".mv_airbnb_neighbourhood_summary;

create materialized view "student_elaheh_badali".mv_airbnb_neighbourhood_summary as
...
on "student_elaheh_badali".mv_airbnb_neighbourhood_summary (neighbourhood);

create index idx_mv_airbnb_num_listings
on "student_elaheh_badali".mv_airbnb_neighbourhood_summary (num_listings);
